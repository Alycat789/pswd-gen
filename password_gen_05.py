...
class Interface:
    ...
    def custom(self):
        ...
        def on_letters():
            if letters.get():
                Radiobutton(custom, text = "both", variable = case, value = 0, state = NORMAL).grid(row = 6, column = 2)
                Radiobutton(custom, text = "upper", variable = case, value = 1, state = NORMAL).grid(row = 6, column = 3)
                Radiobutton(custom, text = "lower", variable = case, value = 2, state = NORMAL).grid(row = 6, column = 4)
            else:
        ...
        Checkbutton(custom, text = "letters", variable = letters, command = on_letters).grid(row = 2, column = 3)
        Checkbutton(custom, text = "symbols", variable = symbols).grid(row = 2, column = 4)
        length_label = Label(custom, text = "Length (>6): ")
